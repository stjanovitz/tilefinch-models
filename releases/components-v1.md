...
This component release provides signed optional downloads for Tilefinch:
...
- Cyrillic script pack — 0.03 MiB
- Extended Latin script pack — 0.03 MiB
...
- Producer inputs: the tracked manifests and pack builder in this repository;
  exact upstream provenance is recorded below.
...
The CJK packs use Noto Sans CJK Regular at upstream commit
`f8d157532fbfaeda587e826d4cd5b21a49186f7c`. Cyrillic and Extended Latin use
Noto Sans 2.015 from Google Fonts commit
`3b1480ea4b6e15fed70a42f4cb29216476a044ed`. The color pack uses Noto Color
...
Font License 1.1, and each generated TFGF contains the complete applicable
license and its source-font digest.
...
| `tilefinch-glyph-cyrillic-v1.tfgf` | 27,680 | `72e684518803eed3eb48b9e58e73984a930dacafff798e504a37d6dba107d72d` |
| `tilefinch-glyph-cyrillic-v1.tfgm` | 238 | `6d5620473b80917c90cd9606124f7306ce08b07808191a778aa66401d0960c3f` |
| `tilefinch-glyph-latin-extended-v1.tfgf` | 33,738 | `2849b7692d7d106d11094c8052e25627c65aec6684e67440e5dd6cbb1be02bc8` |
| `tilefinch-glyph-latin-extended-v1.tfgm` | 250 | `603b87eea4c44bc29df03789339164b6ec0688529612c29e862c790beaaa8b69` |
